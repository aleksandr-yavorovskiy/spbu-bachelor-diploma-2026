...
\begin{frame}{Постановка задачи}
    ...
    \begin{itemize}
        ...
        \item Реализовать разработанное решение и развернуть его на сервере
        \item Провести апробацию среди пользователей
...
\begin{frame}{Апробация и тестирование}
    ...
    \begin{itemize}
        \item На данный момент 2 респондента
        \item Итоговый балл: 71,25
    \end{itemize}
    ...
    \begin{center}
        \includegraphics[width=0.8\textwidth]{figures/test_coverage.png}
    \end{center}
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Реализовано и развернуто на сервере веб-приложение для работы с кириллическими текстами
        \item Проведена апробация среди пользователей, SUS: 71,25
        \item Обеспечено тестовое покрытие кода backend API приложения 91\% операторов (statements)
    \end{itemize}

    % TODOV: исправить отображение
    % \begin{center}
    %     \includegraphics[width=0.05\textwidth]{figures/qr.png}
    % \end{center}
