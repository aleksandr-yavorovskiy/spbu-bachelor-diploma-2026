...
\begin{frame}{Введение}
    ...
    \begin{itemize}
        \item Оцифровка кириллических рукописей: \textbf{\enquote{Цифровой летописец}} совместно с научно-исследовательским отделом рукописей библиотеки \textbf{РАН}
...
\begin{frame}{Архитектура решения (backend)}
    ...
    \begin{itemize}
        ...
        \item Бэкэнд: Python (\textbf{Fast API}) и библиотеки
        \begin{itemize}
            \item docx
            \item PyPDF2
        \end{itemize}
