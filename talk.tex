...
\begin{frame}{Требования}
    ...
    \begin{itemize}
        ...
        \item Корректная конвертация текста между шрифтами
        \item Конвертация между кириллицей и глаголицей
        \item Встроенная экранная клавиатура для ввода спецсимволов
        \item Возможность добавления пользовательских шрифтов
    \end{itemize}
...
\begin{frame}{Обзор шрифтов}
    ...
    % TODO: !!!!! изменить кол-во для ПОНОМАРЬ в буквотитлах на один меньше
    ...
    \begin{table}[H]
     ...
     Выводы:
    \begin{itemize}
        \item \textbf{Menaion Unicode}~--- лучший по количеству верно отображаемых символов
...
\begin{frame}{Архитектура решения}
    ...
    \begin{itemize}
        \item Фронтэнд: Vue.js
        \item Бэкэнд: Python (Fast API) и библиотеки
        \begin{itemize}
            \item docx
            \item PyPDF2
        \end{itemize}
        \item Сборка PDF: XeLaTex
        \item Инфраструктура:
        \begin{itemize}
            \item nginx
            \item Docker, make
...
\begin{frame}{Архитектура решения}
    \todo{Вместо этого использовать компонентную диаграмму}

    \begin{center}
        \includegraphics[width=0.6\textwidth]{figures/class_diagram.png}
    \end{center}
\end{frame}
...
\begin{frame}{Реализация}
    % \todo{REFACTOR}
    \begin{center}
        \includegraphics[width=0.9\textwidth]{figures/demo_new.png}
    \end{center}
\end{frame}
...
\begin{frame}{Апробация и тестирование}
    ...
    Тестовое покрытие (pytest): 89\% операторов
    \begin{center}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item Определен лучший по количеству верно отображаемых символов шрифт~--- Menaion Unicode
